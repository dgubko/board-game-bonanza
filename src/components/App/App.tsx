...
function App() {
  ...
  return (
    <div className="App">
      ...
      <nav>
        <NavLink className={pathname === "/" ? 'button selected' : 'button'} id='top100-button' to="/" >
          Top 100
        </NavLink>
        <NavLink className={pathname === '/favorites' ? 'button selected' : 'button'} id='fav-button' to="/favorites">
          Favorites
        </NavLink>
      </nav>
      <Routes>
